...
import { Employee, EmployeeFormData, EmployeeResponse, POSITION_OPTIONS, GENDER_OPTIONS, PROJECT_OPTIONS, EMPLOYEE_GRADE_OPTIONS } from '@/app/lib/types/hr';
        ...
        const fetchEmployee = async () => {
            try {
                ...
                if (data.success && data.data && !Array.isArray(data.data)) {
                    ...
                    setError(data.message || '직원 정보를 불러오는데 실패했습니다.');
                }
            } catch (error) {
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">직원 정보 수정</h1>
